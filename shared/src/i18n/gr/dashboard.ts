...
const dashboard: TranslationStrings = {
  ...
  'dashboard.dateShiftHint':
    'Συμβουλή: για να μετατοπίσετε μόνο ένα μέρος του δρομολογίου σας, προσθέστε μια ημέρα από την «Αναδιάταξη ημερών» στο ημερήσιο πλάνο και μετακινήστε την εκεί όπου πρέπει να μείνει το κενό.',
