...
const dashboard: TranslationStrings = {
  ...
  'dashboard.dateShiftHint':
    'Совет: чтобы сдвинуть только часть маршрута, добавьте день в разделе «Изменить порядок дней» в планировщике и переместите его туда, где должен появиться промежуток.',
