...
const dashboard: TranslationStrings = {
  ...
  'dashboard.dateShiftHint':
    'Порада: щоб зсунути лише частину маршруту, додайте день у розділі «Змінити порядок днів» у планувальнику й перемістіть його туди, де має з’явитися проміжок.',
